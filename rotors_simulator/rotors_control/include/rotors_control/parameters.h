...
static constexpr double kDefaultMass = 1.56779;                           // 1.56779
static constexpr double kDefaultArmLength = 0.215;                        // 0.215
static constexpr double kDefaultInertiaXx = 0.0347563;                    // 0.0347563
static constexpr double kDefaultInertiaYy = 0.0458929;                    // 0.0458929
static constexpr double kDefaultInertiaZz = 0.0977;                       // 0.0977
static constexpr double kDefaultRotorForceConstant = 8.54858e-6;          // 8.54858e-6
static constexpr double kDefaultRotorMomentConstant = 1.6e-2;             // 1.6e-2
